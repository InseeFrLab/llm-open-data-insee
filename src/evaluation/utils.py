...
def rerank_with_metadata(reranker, query: str, retrieved_docs: list[LangchainDocument], filter_k: int, params: dict):
    ...
    for doc in retrieved_docs:
        ...
        page_content = doc.metadata.get(metadata_field, doc.page_content)
    ...
    reordered_docs = [
        source_to_doc_map[new_doc.metadata["source"]] for new_doc in new_retrieved_docs if new_doc.metadata["source"] in source_to_doc_map
    ]
