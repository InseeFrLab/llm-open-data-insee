def compare_performance_reranking(
    ...
    pages_cited_cols = [
        col for col in columns if col.startswith("Nombre de pages citées")
    ]
    documents_cited_cols = [
        col for col in columns if col.startswith("Nombre de documents cités")
    ]
